        ...
        <div class="col-md-9 p-4">
            <nav class="navbar navbar-expand-lg px-3 rounded shadow-sm">
                <div class="container-fluid px-0">
                    ...
                    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#panelNavbarContent" aria-controls="panelNavbarContent" aria-expanded="false" aria-label="Toggle navigation">
                        <span class="navbar-toggler-icon"></span>
                    </button>

                    <div class="collapse navbar-collapse" id="panelNavbarContent">
                        <ul class="navbar-nav ms-3">
                            <li class="nav-item"><a class="nav-link" href="admin.php">Admin</a></li>
                            <li class="nav-item"><a class="nav-link" href="gestionar_repartidores.php">Repartidores</a></li>
                            <li class="nav-item"><a class="nav-link" href="crear_perfil.php">Crear Perfil</a></li>
                            <li class="nav-item"><a class="nav-link" href="manage_apk.php">APK</a></li>
                        </ul>
